...
config.General.requestName = 'VHToNonbb' #ST_tWll / VHToNonbb
...
#files_ST_tWll / files_VHToNonbb
config.Data.userInputFiles = open('./FileLists/PrivateProd/files_VHToNonbb.txt').readlines()

#ST_tWll_5f_LO_TuneCP5_PSweights_13TeV_madgraph_pythia8_Fall17 / VHToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8_Fall17
config.Data.outputPrimaryDataset = 'VHToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8_Fall17'
config.Data.outputDatasetTag = 'VHToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8_Fall17'

config.Data.publishDBS = 'https://cmsweb.cern.ch/dbs/prod/phys03/DBSWriter'
config.Data.outLFNDirBase = '/store/user/ntonon/FlatTree/tHq2017_v1/'
